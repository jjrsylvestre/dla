...
\begin{tikzpicture}[
	...
	\draw[->] (-1.25,0) to (4.5,0) node[below] {$x$};
	\draw[->] (0,-1.25) -- (0,2.25) node[right] {$y$};

	\foreach \x in {-1,1,2} {
		\draw[opacity=0.25,gray] (\x,-1.25) to (\x,2.25);
		\draw[opacity=0.25,gray] (-1.25,\x) to (4.5,\x);
	}
	\foreach \x in {3,4} {
		\draw[opacity=0.25,gray] (\x,-1.25) to (\x,2.25);
	}
	\node[point] at (2.5,1.5) (p) [label=right:{$P(a,b)$}] {};
