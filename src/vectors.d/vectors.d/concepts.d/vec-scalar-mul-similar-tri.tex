...
\begin{tikzpicture}[
	...
	\draw[dashed] (0,0) to node[below] {$\change{x}$} (1.5,0) to node[right] {$\change{y}$} (1.5,1);
	\draw[dashed] (0,0) to (3,0) to node[right] {$2 \change{y}$} (3,2);
	\node (ddx) at (1.5,-0.75) {$2 \change{x}$};
