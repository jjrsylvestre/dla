...
\DeclareMathOperator{\null}{null}% null space of a matrix (could really just use ker, but want to use this before concept of kernel is introduced)
...
% couple of extra constructs for two-semester version
...
% *********************************************************************
%\newcommand{\basisfont}[1]{\mathscr{#1}}% font for basis
\newcommand{\basisfont}[1]{\mathcal{#1}}% font for basis
