...
\newcommand{\rad}{\;\mathrm{rad}} % radian measure with spacing
...
% geometry
% *********************************************************************
\newcommand{\absegment}[1]{\overline{#1}}% segment through points in arg
...
\newcommand{\abcdquad}[1]{\square\, #1}% quadrilateral through points in arg
% *********************************************************************
...
\newcommand{\bidentmattwo}{\begin{bmatrix} 1 \amp 0 \\ 0 \amp 1 \end{bmatrix}}% two-by-two identity
\newcommand{\bidentmatthree}{\begin{bmatrix} 1 \amp 0 \amp 0 \\ 0 \amp 1 \amp 0 \\ 0 \amp 0 \amp 1 \end{bmatrix}}% three-by-three identity
