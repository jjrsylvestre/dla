...
\begin{tikzpicture}[
	...
	\draw[vector,thick] (o) to node[below right,near end] {$\uvec{v}_3$} (5.2,1.4,1.1);
	\draw[dashed] (4.2,2.4,-0.9) to (5.2,1.4,1.1);
	\draw[vector,thick] (o) to node[left] {$\uvec{e}_3 = \uvec{v}_3 + (- \widetilde{\uvec{v}}_3)$} (1,-1,2);
	\draw[vector,thick] (5.2,1.4,1.1) to node[above] {$- \widetilde{\uvec{v}}_3$} (1,-1,2);
